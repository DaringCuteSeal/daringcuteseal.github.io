...
Oh, this one is trippy! I couldn't really think of the solution myself, so I resorted to looking for hints from the internet. Most people used mixed integer linear programming solvers but I kind of didn't wanna dive into too much math. I then found a great divide-and-conquer algorithm proposed by []()
